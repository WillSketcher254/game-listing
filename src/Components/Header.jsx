...
function Header() {
    ...
    return (
        <div className='flex items-center p-3' >
            ...
            <div className='mx-5 rounded-full flex bg-slate-200 text-black p-2 w-full'>
                <HiMagnifyingGlass />
                <input type="text" placeholder='Search Games' className='px-3 bg-transparent outline-none' />
            </div>
            <div className='mx-5 rounded-full flex bg-slate-200 text-black p-2 cursor-pointer text-[30px]'>
